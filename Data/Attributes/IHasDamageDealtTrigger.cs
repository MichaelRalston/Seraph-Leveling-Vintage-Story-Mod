...
namespace SeraphLeveling.Data.Attributes
{
    ...
    public interface IHasDamageScoredTrigger<D, PD> : ISaveableAttribute where PD : ScoredUnlockedAttributeModifierProgressData<D, PD> where D : ScoredUnlockedAttributeModifierDefinition<D, PD>, IConstructable<D, PD>
    {
        public List<ToolDefinition> Weapons { get; }
