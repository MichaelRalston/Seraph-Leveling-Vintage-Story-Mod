...
namespace SeraphLeveling 
{
    ...
    public class HeavyFootedRemovalProgressData : RemovalProgressData<HeavyFootedRemovalProgressData>, IProgressDataContract<HeavyFootedRemovalProgressData>
    {
        ...
        public static void MarkForSave() {
            SeraphLevelingModSystem.pendingHeavyFootedRemovalProgressSave = true;
        }
        public static ref ConcurrentDictionary<string, HeavyFootedRemovalProgressData> ProgressDictionary() {
            return ref SeraphLevelingModSystem.HeavyFootedRemovalProgress;
        }
    }
